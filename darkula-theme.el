...
(custom-theme-set-faces
 ...
 '(success ((t (:foreground "light green" :weight normal))))
 '(mode-line ((t (:background "#3c3f41" :foreground "#bbbbbb" :box nil))))
 '(mode-line-buffer-id ((t (:weight normal))))
 '(mode-line-inactive ((t (:style released-button :inherit (mode-line) :weight normal :foreground "gray50"))))
 ...
 '(font-lock-preprocessor-face ((t (:foreground "#CC7832"))))
